import{_ as s,c as a,o as n,a5 as i}from"./chunks/framework.BBnPlPAH.js";const d=JSON.parse('{"title":"Spring注解驱动开发【源码】——AOP原理总结","description":"","frontmatter":{"title":"Spring注解驱动开发【源码】——AOP原理总结","date":"2022-02-07T21:26:32.000Z","tags":null},"headers":[],"relativePath":"spring/annotation/15-SummaryOfAOP.md","filePath":"spring/annotation/15-SummaryOfAOP.md","lastUpdated":1729870203000}'),p={name:"spring/annotation/15-SummaryOfAOP.md"},e=i(`<div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
